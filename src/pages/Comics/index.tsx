...
export const Comics: React.FC = () => {
    ...
    const handleSearchByKeyPress = (event: React.KeyboardEvent<HTMLInputElement>) => ([event.code, event.key].includes("Enter")) ? getComics(searchPage) : null;
                            ...
                            <>
                                <div className="mb-4">                
                                    <Pagination 
                                        ...
                                        onPageChange={(event) => getComics(event.selected + 1, inputName)
                                        }
                                    /> 
                                </div>
