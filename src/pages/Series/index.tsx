...
export const Series: React.FC = () => {
    ...
    const handleSearchByKeyPress = (event: React.KeyboardEvent<HTMLInputElement>) => ([event.code, event.key].includes("Enter")) ? getSeries(searchPage) : null;
                            ...
                            <>
                                <div className="mb-4">                
                                    <Pagination 
                                        ...
                                        onPageChange={(event) => getSeries(event.selected + 1, inputName)
                                        }
                                    /> 
                                </div>
