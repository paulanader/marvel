...
export const Creators: React.FC = () => {
    ...
    const handleSearchByKeyPress = (event: React.KeyboardEvent<HTMLInputElement>) => ([event.code, event.key].includes("Enter")) ? getCreators(searchPage) : null;
                        ...
                        <div className="row row-cols-4 g-4 mb-5">
                            {creators.map((creator) => (
                                <div key={creator.fullName} className="col d-flex">
                                    ...
                                    image= {
                                        getThumbnail(creator.thumbnail)
                                    }  
                                    idroute={creator.id}
                                />
                                 </div>
                            ...
                            <>
                                <div className="mb-4">                
                                    <Pagination 
                                        ...
                                        onPageChange={(event) => getCreators(event.selected + 1, inputName)
                                        }
                                    /> 
                                </div>
