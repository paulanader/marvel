...
export const Characters: React.FC = () => {
    ...
    const handleSearchByKeyPress = (event: React.KeyboardEvent<HTMLInputElement>) => ([event.code, event.key].includes("Enter")) ? getCharacters(1, inputName) : null;
                        ...
                        <div className="row row-cols-4 g-4 mb-5">
                            {characters.map((character) => (
                                <div key={character.name} className="col d-flex">
                                    ...
                                    name={character.name}
                                    image= {
                                        getThumbnail(character.thumbnail)
                                    }  
                            ...
                            <>
                                <div className="mb-4">                
                                    <Pagination 
                                        ...
                                        onPageChange={(event) => getCharacters(event.selected + 1, inputName)
                                        }
                                    /> 
                                </div>
