...
export const Events: React.FC = () => {
    ...
    const handleSearchByKeyPress = (ev: React.KeyboardEvent<HTMLInputElement>) => ([ev.code, ev.key].includes("Enter")) ? getEvents(searchPage) : null;
    const handleChangePageInput = (ev: React.ChangeEvent<HTMLInputElement>) => setSearchPage( parseInt(ev.target.value, 10))
